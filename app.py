...
HOME_BODY_HTML = """<article class="card card-body shadow-sm mb-4">
  ...
  <h3 class="h5 mt-3">How to use this site in 3 simple steps</h3>
  <ol class="mb-3">
    <li>
      <strong>Enter your birth details in the form above.</strong>
      Use the place search to auto-fill latitude, longitude and time zone. You can
    ...
    <li>
      <strong>Compare with your real life.</strong>
      Use our guides below to log your past decisions, events and outcomes, and see
      where your chart seems to “fit” and where it clearly doesn’t.
    </li>
  </ol>

  <h3 class="h5 mt-3">What the free timeline actually shows</h3>
  <p>
    The timeline generated by the tool above is not a random “fortune cookie”
    horoscope. It is based on standard Jyotiṣa techniques:
  </p>
  <ul>
    <li>Planetary periods (mahā-dashā and antar-dashā) for a time-based storyline.</li>
    <li>
    ...
    <li>
      ...
      that can boost or weaken a period.
    </li>
  </ul>
  <p>
    The goal is to give you a <strong>timeline you can think with</strong>: a structured
    story of when certain themes are more likely to be active, so that you can
    combine this with common sense, skill and effort.
  </p>

  <h3 class="h5 mt-3">How to fact-check astrology against your real life</h3>
  <p>
    A core idea of this site is that astrology should be <strong>testable in your own
    life</strong>, not just accepted blindly. Once you have generated your timeline:
  </p>
  <ul>
    <li>
      Make a list of 10–20 major events in your life so far (jobs, moves, health
      events, relationships, big disruptions or breakthroughs).
    </li>
    <li>
      Note the approximate dates and see which dashā / sub-periods and transits
      were active at those times.
    </li>
    <li>
      Ask: “Does this period match the theme of what actually happened?” rather
      than trying to force a fit.
    </li>
  </ul>
  <p>
    Our detailed guides (linked below) walk you step-by-step through this process,
    from building a <strong>life-event log</strong> to calculating a simple
    “karma–noise ratio” that shows how often your chart seems to match reality,
    and where chance or environment clearly played a bigger role.
  </p>

  <h3 class="h5 mt-3">Responsible &amp; ethical use</h3>
  <p>
    Astrology can be inspiring, but it can also be misused to create fear or
    dependency. Graha Guidance is designed to <strong>support</strong> your decisions,
    not replace your judgement. Some important points:
  </p>
  <ul>
    <li>
      Do not make medical, legal or financial decisions based on this tool alone.
      Always consult qualified professionals where needed.
    </li>
    <li>
      Use astrology as one layer of information alongside your skills, savings,
      relationships, mental health and practical opportunities.
    </li>
    <li>
      Be sceptical of anyone selling guaranteed results, fear-based remedies or
      expensive rituals as the only solution.
    </li>
  </ul>
  <p>
    You’ll also find a dedicated guide on <strong>ethics and consent-based remedies</strong>
    in the featured articles below, including a checklist of questions to ask any
    astrologer before you agree to costly upāyas.
  </p>

  <h3 class="h5 mt-3">What to do after you get your first timeline</h3>
  <p>
    Once you have your first chart and timeline from the tool above, you can:
  </p>
  <ul>
    <li>Create a simple <strong>dashā diary</strong>, logging mood, events and big decisions.</li>
    <li>
      Mark your <strong>green zones</strong> (periods where career / money factors look
      relatively supportive) and <strong>red zones</strong> (periods where caution and
      backup plans matter more).
    </li>
    <li>
      Use our journaling templates to build your own long-term picture of what each
      planet really seems to do in <em>your</em> life.
    </li>
  </ul>
  <p>
    Over time, this becomes your personal evidence base: where astrology helped,
    where it didn’t, and what kind of decisions you tend to make under different
    influences.
  </p>

  <h3 class="h5 mt-3">A quick note on privacy</h3>
  <p>
    You can use the tool without entering your real name. Birth details entered
    into the form above are used only for calculation and display of your chart
    and are not shared publicly on the site. For more details, please see our
    <a href="/privacy-policy">Privacy Policy</a> and
    <a href="/disclaimer">Disclaimer</a>.
  </p>

  <h3 class="h5 mt-3">Start exploring our deep-dive guides</h3>
  <p>
    Below are some of the in-depth articles available on this site. They are
    designed to be practical workbooks and checklists, not just theory. Generate
    your chart using the form above, then open the relevant guide and follow the
    steps with your own data.
  </p>
</article>

<section class="mb-4">
  <h2 class="h5 mb-3">Featured Guides on Using Astrology Wisely</h2>
  <div class="row">
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Astrology vs Reality: A Guided Workbook</h3>
          <p class="small text-muted">
            Learn how to list your major life events, map them to dashā periods
            and honestly score how often your chart seems to “fit”.
          </p>
          <a href="/guides/astrology-vs-reality-workbook" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">The Karma–Noise Ratio</h3>
          <p class="small text-muted">
            A simple framework to separate what might be shown by your chart from
            what is more likely environment, chance or free will.
          </p>
          <a href="/guides/karma-noise-ratio" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Self-Experimenting with Dashās</h3>
          <p class="small text-muted">
            Turn your dashā periods into a personal experiment with structured
            logging, tags and periodic reviews.
          </p>
          <a href="/guides/self-experimenting-with-dashas" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">When Transits Fail</h3>
          <p class="small text-muted">
            Honest case studies where expectations from transits did not match
            reality, and what we can learn from those failures.
          </p>
          <a href="/guides/when-transits-fail" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Consent-Based Remedies Checklist</h3>
          <p class="small text-muted">
            A practical checklist of questions to ask before agreeing to any
            costly remedy, gemstone or ritual.
          </p>
          <a href="/guides/consent-based-remedies" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Astrology for Big Life Bets</h3>
          <p class="small text-muted">
            A risk-checklist that combines chart factors with practical money,
            career and relationship considerations.
          </p>
          <a href="/guides/astrology-for-big-life-bets" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Twin Charts, Different Lives</h3>
          <p class="small text-muted">
            Explore how similar charts can lead to different outcomes, and what
            that means for free will and environment.
          </p>
          <a href="/guides/twin-charts-different-lives" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      <div class="card h-100 shadow-sm border-0">
        <div class="card-body">
          <h3 class="h6">Divisional Chart Reality-Check</h3>
          <p class="small text-muted">
            A step-by-step method to see whether your Navāṁśa and Daśāṁśa actually
            match your relationship and career story.
          </p>
          <a href="/guides/divisional-chart-reality-check" class="small text-decoration-none">
            Read guide &rarr;
          </a>
        </div>
      </div>
